...
export const FIELD_GUIDES = {
  ...
  adoptedBaseVotes: { format: 'Whole number of votes', flowsTo: 'Persuasion need' },
  persuasionUniverseSize: { format: 'Whole number of people', flowsTo: 'Required supporter yield' },
  persuasionSupporterTurnoutRate: { format: '0–100%', flowsTo: 'Required persuasion supporters' },
